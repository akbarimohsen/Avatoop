...
class CreateUserRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            "password.regex" => "رمز عبور باید دارای کاراکترهای انگلیسی (حروف بزرگ و کوچیک) و عدد و کاراکترهای خاص (@*#) باشد. ضمنا رمز عبور باید حداقل 8 کاراکتر باشد و حداکثر 15 کاراکتر باشد.",
