                        ...
                        <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    {!! Form::label('username','نام کاربر',['class'=>'text-capitalize']) !!}
                                    {!! Form::text('username',old('username'),['class'=>'form-control','placeholder'=>'نام کاربر را وارد کنید']) !!}
                                    @error('username')
                                ...
                                <section class="form-group col-12">
                                    {!! Form::submit('ذخیره ویرایش انجام شده',['class'=>'btn btn-outline-success mt-3']) !!}
                                </section>
                            </div>
                            {!! Form::close() !!}
                        </div>
