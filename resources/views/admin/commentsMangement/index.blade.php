        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">مدیریت نظرات</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
            ...
            <div class="card-body p-0">
              <ul class="nav nav-pills flex-column">
                <li class="nav-item @if($category == null) bg-primary @endif">
                  <a href="{{ route('admin.comments', ['category' => null]) }}" class="nav-link">
        ...
        <div class="col-md-9">
            ...
            @endif
            @livewire('admin.comments-management.show-comments', ['comments' => $comments, 'category' => $category])
          <!-- /. box -->
        </div>
        <!-- /.col -->
      </div>
