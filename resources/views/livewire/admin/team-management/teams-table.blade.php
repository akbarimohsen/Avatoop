                    ...
                    <div class="card p-3  py-4">
                        ...
                        <form class="row g-3 mt-2" wire:submit.prevent="searchTeam">
                            ...
                            <div class="col-md-3">
                                ...
                                <button class="btn btn-outline-info btn-block" type="submit">جستجو</button>
                        ...
                        <div class="row m-1 mt-3 d-flex justify-content-center">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('admin.teams.add') }}" class="btn btn-outline-success w-100">افزودن تیم جدید</a>
                            </div>
                        </div>
                    </div>
                </div>
