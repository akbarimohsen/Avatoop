                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    {!! Form::label('newsHeader','سر تیتر خبر',['class'=>'text-capitalize']) !!}
                                    {!! Form::text('newsHeader',old('newsHeader'),['class'=>'form-control','placeholder'=>'مثلا:بازیکن تیم B با نام A جنجال بزرگی آفرید']) !!}
                                    @error('header')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
